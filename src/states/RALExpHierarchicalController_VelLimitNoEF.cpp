#include "RALExpHierarchicalController_VelLimitNoEF.h"

#include <mc_tvm/Robot.h>
#include <RALExpHierarchicalController/RALExpHierarchicalController.h>

void RALExpHierarchicalController_VelLimitNoEF::configure(const mc_rtc::Configuration & config) {}

void RALExpHierarchicalController_VelLimitNoEF::start(mc_control::fsm::Controller & ctl_)
{
...
bool RALExpHierarchicalController_VelLimitNoEF::run(mc_control::fsm::Controller & ctl_)
{
  auto & ctl = static_cast<RALExpHierarchicalController &>(ctl_);
...
void RALExpHierarchicalController_VelLimitNoEF::teardown(mc_control::fsm::Controller & ctl_)
{
  auto & ctl = static_cast<RALExpHierarchicalController &>(ctl_);
...
EXPORT_SINGLE_STATE("RALExpHierarchicalController_VelLimitNoEF", RALExpHierarchicalController_VelLimitNoEF)
