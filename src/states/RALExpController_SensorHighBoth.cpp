#include "RALExpController_SensorHighBoth.h"

#include <RALExpController/RALExpController.h>

void RALExpController_SensorHighBoth::configure(const mc_rtc::Configuration & config) {}

void RALExpController_SensorHighBoth::start(mc_control::fsm::Controller & ctl_)
{
...
bool RALExpController_SensorHighBoth::run(mc_control::fsm::Controller & ctl_)
{
  auto & ctl = static_cast<RALExpController &>(ctl_);
  output("OK"); 
  return true;
...
void RALExpController_SensorHighBoth::teardown(mc_control::fsm::Controller & ctl_)
{
  auto & ctl = static_cast<RALExpController &>(ctl_);
}

EXPORT_SINGLE_STATE("RALExpController_SensorHighBoth", RALExpController_SensorHighBoth)
