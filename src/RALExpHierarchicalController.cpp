...
RALExpHierarchicalController::RALExpHierarchicalController(mc_rbdyn::RobotModulePtr rm, double dt, const mc_rtc::Configuration & config)
: mc_control::fsm::Controller(rm, dt, config, Backend::TVM)
{
  ...
  mc_rtc::log::success("[RALExpHierarchicalController] Controller's init ... DONE ");
}

bool RALExpHierarchicalController::run()
{
...
void RALExpHierarchicalController::reset(const mc_control::ControllerResetData & reset_data)
{
  mc_control::fsm::Controller::reset(reset_data);
}

void RALExpHierarchicalController::getPostureTarget(void)
{
